...
<head>
    ...
    <style>
        * {
        ...
        .summary-card.target .summary-card-title {
            color: #7c3aed;
        }

        .summary-card.expense .summary-card-title {
            color: #dc2626;
        }

        .summary-card.income .summary-card-title {
            color: #16a34a;
        }

        .summary-card.balance .summary-card-title {
            color: #2563eb;
        }
        ...
        .summary-card.target .summary-card-value {
            color: #7c3aed;
        }
