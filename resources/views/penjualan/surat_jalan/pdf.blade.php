            ...
            <div class="header-left">
                <div class="logo-wrapper">
                    ...
                    <div class="company-cell">
                        <div class="company-name">KODE LUNAK TECH</div>
                    </div>
                </div>
                <div class="company-info">
                    ...
                    Telp: 08881930769<br>
                    Email: <a href="#">kodelunainterior@gmail.com</a> |
                    <img src="{{ public_path('images/facebook.svg') }}" alt="Facebook" style="height:10px;vertical-align:middle;"> Facebook: Kode Lunak Tech interiors<br>
                    <img src="{{ public_path('images/instagram.svg') }}" alt="Instagram" style="height:10px;vertical-align:middle;"> Instagram: Kodelunakinterior |
                    <img src="{{ public_path('images/tiktok.svg') }}" alt="TikTok" style="height:10px;vertical-align:middle;"> TikTok: Kodelunakinterior
                </div>
            </div>
